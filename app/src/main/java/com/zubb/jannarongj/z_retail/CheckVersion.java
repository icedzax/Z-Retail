...
//        lurl = "http://199.0.0.16/version/version.php?n=";
        ...
        /*if(ip!= null && ip.substring(8,11).equals("116")){
        ...
        else if(ip!= null && ip.substring(8,11).equals("171")){
            connectionClass.setUdbn("PP");
            connectionClass.setUip("192.168.100.222");
            connectionClass.setUpass("");
        }
            ...
            connectionClass.setUip("199.0.0.100");
            connectionClass.setUpass("itsteel1983");
            lurl = "http://199.0.0.10/version/version.php?n=";
        }
*/
      /*  connectionClass.setUdbn("PP");
        connectionClass.setUip("199.0.0.100");
...
//                z = ex.getMessage().toString();
    ...
    class DownloadNewVersion extends AsyncTask<String,Integer,Boolean> {
        ...
        protected Boolean doInBackground(String... arg0) {
            ...
            try {
                ...
                Log.e("UDRR","Update Error: " + e.getMessage());
    ...
    void OpenNewVersion(String location) {
        location.replaceAll("file","content");
...
//                z = ex.getMessage().toString();
    ...
    class DownloadNewVersion extends AsyncTask<String,Integer,Boolean> {
        ...
        protected void onProgressUpdate(Integer... progress) {
            ...
            }else { //high hope high hope and you let you go go out again
