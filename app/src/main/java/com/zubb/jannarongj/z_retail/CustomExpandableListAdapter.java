...
public class CustomExpandableListAdapter extends BaseExpandableListAdapter {
  ...
  /*  interface OnChildClickListener {
        void onChildClick(int listPosition, int expandedListPosition, boolean isLastChild, View view);
        boolean onChildLongClick(int listPosition, int expandedListPosition, boolean isLastChild, View view);
    }
...
*/
    ...
    public Object getChildX(int listPosition, int expandedListPosition) {
        return this.expandableListDetail.get(this.expandableListTitle.get(listPosition+1))
                .get(expandedListPosition);
    }
